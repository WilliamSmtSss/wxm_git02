...
import com.splan.xbet.back.backforbusiness.mappers.SysPermissionMapper;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    private JSONObject getUserPermissionFromDB(String username) {
        ...
        if (adminRoleId == userPermission.getIntValue(roleIdKey) || 2==userPermission.getIntValue(roleIdKey)) {
            //查询所有菜单  所有权限
