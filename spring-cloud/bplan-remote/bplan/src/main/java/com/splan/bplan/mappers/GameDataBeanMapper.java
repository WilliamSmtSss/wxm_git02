...
public interface GameDataBeanMapper extends SuperMapper<GameDataBean> {
    ...
    @Results({
            ...
            @Result(column = "id",property = "beToRolling",one = @One(select = "com.splan.bplan.mappers.BetTopicsBeanMapper.countBeToRollingByDataId")),
            @Result(column = "id",property = "rollingBall",one = @One(select = "com.splan.bplan.mappers.BetTopicsBeanMapper.countRollingByDataId"))
    })
    ...
    @Results({
            ...
            @Result(column = "id",property = "teams",many = @Many(select = "com.splan.bplan.mappers.GameDataTeamBeanMapper.selectGameDataTeamByDataId")),
            @Result(column = "id",property = "odds",one = @One(select = "com.splan.bplan.mappers.BetTopicsBeanMapper.selectSeriesByDataId")),
            @Result(column = "id",property = "betCount",one = @One(select = "com.splan.bplan.mappers.BetTopicsBeanMapper.countEndByDataId"))
    })
    ...
    @Results({
            ...
            @Result(column = "league_id",property = "league",one=@One(select = "com.splan.bplan.mappers.GameLeagueBeanMapper.selectById")),
            @Result(column = "id",property = "scores",many = @Many(select = "com.splan.bplan.mappers.GameScoreBeanMapper.selectByDataId")),
            @Result(column = "id",property = "campaigns",many = @Many(select = "com.splan.bplan.mappers.GameCampaignBeanMapper.selectAllByDataId")),
            @Result(column = "id",property = "teams",many = @Many(select = "com.splan.bplan.mappers.GameDataTeamBeanMapper.selectGameDataTeamByDataId")),
            @Result(column = "id",property = "rollingBall",one = @One(select = "com.splan.bplan.mappers.BetTopicsBeanMapper.countRollingByDataId"))
    })
    ...
    @Results({
            @Result(id=true,property="id",column="id",javaType=Integer.class),
            @Result(column = "league_id",property = "league",one=@One(select = "com.splan.bplan.mappers.GameLeagueBeanMapper.selectById")),
            @Result(column = "game_id",property = "gameTypeBean",one=@One(select = "com.splan.bplan.mappers.GameTypeBeanMapper.selectById")),
            @Result(column = "id",property = "teams",many = @Many(select = "com.splan.bplan.mappers.GameDataTeamBeanMapper.selectGameDataTeamByDataId"))
    })
    ...
    @Results({
            ...
            @Result(column = "id",property = "teams",many = @Many(select = "com.splan.bplan.mappers.GameDataTeamBeanMapper.selectGameDataTeamByDataId")),
            @Result(column = "game_id",property = "gameTypeBean",one=@One(select = "com.splan.bplan.mappers.GameTypeBeanMapper.selectById")),
            @Result(column = "id",property = "orderCount",many = @Many(select = "com.splan.bplan.mappers.BetOrderDetailBeanMapper.countOrder"))
    })
