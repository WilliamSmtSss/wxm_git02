...
public interface BetOrderDetailBeanMapper extends SuperMapper<BetOrderDetailBean> {
    ...
    @Results({
            ...
            @Result(column = "data_id",property = "gameResultList",many = @Many(select = "com.splan.bplan.mappers.GameDataBeanMapper.selectGameWithTeamCampainsResultById"))
    ...
    @Results({
            @Result(column = "bet_order_id",property = "betOrderBean",one = @One(select = "com.splan.bplan.mappers.BetOrderBeanMapper.selectById"))
