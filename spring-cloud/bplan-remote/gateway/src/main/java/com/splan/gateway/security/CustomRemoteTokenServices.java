package com.splan.gateway.security;


import com.splan.gateway.exception.ErrorCode;
    ...
    public Map<String, Object> loadAuthentication(String accessToken) {
        ...
        if (map.containsKey(ERROR)) {
            ...
            if (code == HttpStatus.UNAUTHORIZED) {
                ...
                throw new ServerException(HttpStatus.BAD_REQUEST, new ErrorCode(false,1002, "认证失败", "your identity id illegal!"));
            } else {
