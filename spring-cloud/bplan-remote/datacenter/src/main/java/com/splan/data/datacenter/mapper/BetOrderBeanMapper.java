...
import com.splan.data.datacenter.dto.BetOrderResult;
import com.splan.data.datacenter.dto.ScreenForBetOrderDto;
...
public interface BetOrderBeanMapper extends SuperMapper<BetOrderBean> {
    ...
    @Results({
            ...
            @Result(column = "id",property = "betOrderDetails",many = @Many(select = "com.splan.xbet.admin.back.mappers.BetOrderDetailBeanMapper.selectByOrderId"))
    })
    ...
    BigDecimal getTotleOrderByuserId(Long userId);
